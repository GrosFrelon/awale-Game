...
client.app: Client/client.c Client/client.h
	gcc -o client.app Client/client.c

Serveur/awale.o: Serveur/awale.c Serveur/awale.h
	cd Serveur/ && gcc -c awale.c

Serveur/liste_chaine.o: Serveur/liste_chaine.c Serveur/liste_chaine.h
	cd Serveur/ && gcc -c liste_chaine.c

Serveur/server.o: Serveur/server.c Serveur/server.h
	cd Serveur/ && gcc -c server.c

Serveur/socket.o: Serveur/socket.c Serveur/socket.h
